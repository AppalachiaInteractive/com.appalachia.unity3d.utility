    ...
    internal static partial class Number
    {
        ...
        internal unsafe ref struct BigInteger
        {
                ...
                out BigInteger rem)
            {
                ...
                {
                    var quotient = MathEx.DivRem(lhs._blocks[0], rhs._blocks[0], out var remainder);
                ...
                if (rhsLength == 1)
                {
                    ...
                    for (var i = quoLength - 1; i >= 0; i--)
                    {
                        ...
                        var digit = MathEx.DivRem(value, rhsValue, out carry);
            ...
            public static void Multiply(ref BigInteger lhs, ref BigInteger rhs, out BigInteger result)
            {
                ...
                while (smallIndex < smallLength)
                {
                    ...
                    if (small._blocks[smallIndex] != 0)
                    {
                        ...
                        do
                        {
                            var product = result._blocks[resultIndex] +
            ...
            public static void Pow10(uint exponent, out BigInteger result)
            {
                ...
                Debug.Assert(
                    (s_Pow10BigNumTableIndices[s_Pow10BigNumTableIndices.Length - 1] + MaxBlockCount + 2) ==
                    s_Pow10BigNumTable.Length
                );
            ...
            public static void SetValue(out BigInteger result, ref BigInteger value)
            {
                ...
                BufferEx.Memcpy(
                    (byte*)result.GetBlocksPointer(),
                    (byte*)value.GetBlocksPointer(),
                    rhsLength * sizeof(uint)
                );
            }
