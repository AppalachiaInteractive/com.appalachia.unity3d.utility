    ...
    internal unsafe partial class Number
    {
        ...
        public readonly struct FloatingPointInfo
        {
                ...
                ulong infinityBits)
            {
                ...
                NormalMantissaBits =
                    (ushort)(denormalMantissaBits + 1); // we get an extra (hidden) bit for normal mantissas
            ...
            bool hasZeroTail)
        {
            ...
            Debug.Assert(
                (shiftedExponent & ~(((1UL << info.ExponentBits) - 1) << info.DenormalMantissaBits)) == 0
            ...
            bool hasNonZeroFractionalPart)
        {
            ...
            var topBlockIndex = MathEx.DivRem(integerBitsOfPrecision, 32, out var topBlockBits);
            ...
            uint fractionalDigitsPresent)
        {
            ...
            if ((integerBitsOfPrecision == 0) &&
                ((fractionalDenominatorExponent - (int)totalDigits) > info.OverflowDecimalExponent))
            {
            ...
            BigInteger.DivRem(
                ...
                out var bigFractionalMantissa,
                out var fractionalRemainder
            );
            ...
            var completeMantissa = (integerMantissa << (int)requiredFractionalBitsOfPrecision) +
                                   fractionalMantissa;
