...
namespace Appalachia.Utility.Strings.Number
{
    internal static partial class Number
    {
        ...
        internal static class Grisu3
        {
            ...
            {
                var v = IsNegative(value) ? -value : value;
                ...
                {
                    var w = DiyFp.CreateAndGetBoundaries(v, out var boundaryMinus, out var boundaryPlus)
                                 .Normalize();
                ...
                out int decimalExponent)
            {
                ...
                var tenMk = GetCachedPowerForBinaryExponentRange(
                ...
                out int decimalExponent)
            {
                ...
                var result = TryDigitGenShortest(
                ...
                out int kappa)
            {
                ...
                if ((fractionals == 0) &&
                    ((requestedDigits >= 11) || (integrals < s_SmallPowersOfTen[requestedDigits - 1])))
                {
                ...
                while (kappa > 0)
                {
                    var digit = MathEx.DivRem(integrals, divisor, out integrals);
                ...
                return TryRoundWeedCounted(buffer, length, fractionals, one.f, wError, ref kappa);
            }
