        ...
        internal static Utf16FormatSegment[] Utf16Parse(string format)
        {
            ...
            while (true)
            {
                while (i < len)
                {
                    ...
                    {
                        list.Add(
                            new Utf16FormatSegment(copyFrom, size, Utf16FormatSegment.NotFormatIndex, 0)
                        );
                    }
                ...
                list.Add(
                    new Utf16FormatSegment(
                        indexParse.LastIndex - indexParse.FormatString.Length - 1,
                        indexParse.FormatString.Length,
                        indexParse.Index,
            ...
            while (true)
            {
                while (i < len)
                {
                    ...
                    if (size != 0)
                    {
                        ...
                        list.Add(
                            new Utf8FormatSegment(
                                bufOffset,
                                utf8size,
                                Utf8FormatSegment.NotFormatIndex,
                                default,
                                0
                            )
                        );
                ...
                list.Add(
                    new Utf8FormatSegment(
                        ...
                        0,
                        indexParse.Index,
                        StandardFormat.Parse(indexParse.FormatString),
                        indexParse.Alignment
                    )
                );
            }
