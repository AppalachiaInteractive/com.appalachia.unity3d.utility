...
namespace Appalachia.Utility.Strings
{
                                                   ...
                                                   IResettableBufferWriter<byte>
    {
        ...
        [ThreadStatic] private static byte[] scratchBuffer;
        ...
        ///     This exception is thrown when <c>new StringBuilder(disposeImmediately: true)</c> or <c>ZString.CreateUtf8StringBuilder(notNested: true)</c> is
        ///     nested.
        ///     See the README.md
        /// </exception>
