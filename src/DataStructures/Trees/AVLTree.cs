...
namespace Appalachia.Utility.DataStructures.Trees
{
        ...
        where T : IComparable<T>
    {
        ...
        private void _rebalanceSubtreeTreeAt(AVLTreeNode<T> currentNode)
        {
            ...
            var balance = _getBalanceFactor(currentNode);
            ...
            if (Math.Abs(balance) >= 2) // -2 or 2; -3 or 3 ... etc
            {
                ...
                if (balance > 0)
                {
                    var rightSubtreeBalance = _getBalanceFactor(currentNode.RightChild);
                ...
                {
                    var leftSubtreeBalance = _getBalanceFactor(currentNode.LeftChild);
