...
namespace Appalachia.Utility.DataStructures.Trees
{
    ...
    /// </summary>
    public class BSTRankedNode<T> : BSTNode<T>
        where T : IComparable<T>
    {
        ...
        public BSTRankedNode(
            T value,
            int subtreeSize,
            BSTRankedNode<T> parent,
            BSTRankedNode<T> left,
            BSTRankedNode<T> right)
        {
            base.Value = value;
    ...
    /// </summary>
    public class AugmentedBinarySearchTree<T> : BinarySearchTree<T>
        where T : IComparable<T>
    {
        /// <summary>
        ///     CONSTRUCTOR.
        ...
        protected bool _remove(BSTRankedNode<T> node)
        {
            ...
            {
                base._replaceNodeInParent(node);
                _updateSubtreeSize(parent);
                _count--;
            }
