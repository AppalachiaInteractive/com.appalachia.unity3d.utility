namespace Appalachia.Utility.DataStructures.Trees
{
    ...
    /// </summary>
    public class RedBlackTreeMapNode<TKey, TValue> : BSTMapNode<TKey, TValue>
        where TKey : System.IComparable<TKey>
    {
        ...
        public RedBlackTreeMapNode(
            TKey key,
            TValue value,
            int height,
            RedBlackTreeMapNode<TKey, TValue> parent,
            RedBlackTreeMapNode<TKey, TValue> left,
            RedBlackTreeMapNode<TKey, TValue> right)
        {
            Key = key;
            Value = value;
