...
namespace Appalachia.Utility.DataStructures.Trees
{
    ...
    /// </summary>
    public class BinarySearchTreeMap<TKey, TValue> : IBinarySearchTree<TKey, TValue>
        where TKey : IComparable<TKey>
    {
        ...
        /// </summary>
        protected virtual void _findAll(
            BSTMapNode<TKey, TValue> currentNode,
        ...
        /// </summary>
        protected virtual void _inOrderTraverse(
            BSTMapNode<TKey, TValue> currentNode,
            ref List<KeyValuePair<TKey, TValue>> list)
        {
            if (currentNode == null)
        ...
        ///     Used in the recusive _remove function.
        /// </summary>
        protected virtual void _replaceNodeInParent(
        ...
        #region Nested type: BinarySearchTreeInOrderEnumerator
        ...
        internal class BinarySearchTreeInOrderEnumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            ...
            public KeyValuePair<TKey, TValue> Current =>
                new KeyValuePair<TKey, TValue>(current.Key, current.Value);
        ...
        #region Nested type: BinarySearchTreePostOrderEnumerator
        ...
        #region Nested type: BinarySearchTreePreOrderEnumerator
