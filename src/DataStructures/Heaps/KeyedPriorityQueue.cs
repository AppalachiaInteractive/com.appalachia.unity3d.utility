...
namespace Appalachia.Utility.DataStructures.Heaps
{
    ...
    /// <typeparam name="V">Node's Value type</typeparam>
    /// <typeparam name="P">Node's Priority type</typeparam>
    public class PriorityQueueNode<K, V, P> : IComparable<PriorityQueueNode<K, V, P>>
        where P : IComparable<P>
    {
        ...
        #region IComparable<PriorityQueueNode<K,V,P>> Members
    ...
    /// </summary>
    public class PriorityQueueNodeComparer<K, V, P> : IComparer<PriorityQueueNode<K, V, P>>
        where P : IComparable<P>
    {
        #region IComparer<PriorityQueueNode<K,V,P>> Members
