...
namespace Appalachia.Utility.DataStructures.Dictionaries
{
    ...
    /// </summary>
    public class ChainedHashTable<TKey, TValue> : IDictionary<TKey, TValue>
        ...
        public bool Contains(KeyValuePair<TKey, TValue> item)
        {
            ...
            if ((_hashTableStore[hashcode] != null) && (_hashTableStore[hashcode].Count > 0))
            {
                try
                {
                    ...
                    if (existingPair.Key.IsEqualTo(item.Key) &&
                        _valuesComparer.Equals(existingPair.Value, item.Value))
                    {
                        return true;
                    }
                }
        ...
        public bool Remove(KeyValuePair<TKey, TValue> item)
        {
            ...
            if ((_hashTableStore[hashcode] != null) && (_hashTableStore[hashcode].Count > 0))
            {
                try
                {
                    ...
                    if (keyValuePair.Key.IsEqualTo(item.Key) &&
                        _valuesComparer.Equals(keyValuePair.Value, item.Value))
                    {
