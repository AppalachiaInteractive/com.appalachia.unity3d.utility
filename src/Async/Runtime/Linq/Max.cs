...
namespace Appalachia.Utility.Async.Linq
{
    ...
    {
        public static AppaTask<TSource> MaxAsync<TSource>(
        ...
        public static AppaTask<TResult> MaxAsync<TSource, TResult>(
            this IAppaTaskAsyncEnumerable<TSource> source,
        ...
        public static AppaTask<TResult> MaxAwaitAsync<TSource, TResult>(
            this IAppaTaskAsyncEnumerable<TSource> source,
        ...
        public static AppaTask<TResult> MaxAwaitWithCancellationAsync<TSource, TResult>(
            this IAppaTaskAsyncEnumerable<TSource> source,
    ...
    {
        public static async AppaTask<TSource> MaxAsync<TSource>(
        ...
        public static async AppaTask<TResult> MaxAsync<TSource, TResult>(
            IAppaTaskAsyncEnumerable<TSource> source,
            Func<TSource, TResult> selector,
            CancellationToken cancellationToken)
        {
        ...
        public static async AppaTask<TResult> MaxAwaitAsync<TSource, TResult>(
            IAppaTaskAsyncEnumerable<TSource> source,
            Func<TSource, AppaTask<TResult>> selector,
            CancellationToken cancellationToken)
        {
        ...
        public static async AppaTask<TResult> MaxAwaitWithCancellationAsync<TSource, TResult>(
            IAppaTaskAsyncEnumerable<TSource> source,
            Func<TSource, CancellationToken, AppaTask<TResult>> selector,
            CancellationToken cancellationToken)
        {
