...
namespace Appalachia.Utility.Async.Linq
{
    ...
    {
        public static IAppaTaskAsyncEnumerable<IList<TSource>> Buffer<TSource>(
    ...
    internal sealed class Buffer<TSource> : IAppaTaskAsyncEnumerable<IList<TSource>>
    {
        private readonly IAppaTaskAsyncEnumerable<TSource> source;
        private readonly int count;

        public Buffer(IAppaTaskAsyncEnumerable<TSource> source, int count)
        {
            this.source = source;
            this.count = count;
        }

        public IAppaTaskAsyncEnumerator<IList<TSource>> GetAsyncEnumerator(
            CancellationToken cancellationToken = default)
        {
            return new _Buffer(source, count, cancellationToken);
        }

        private sealed class _Buffer : MoveNextSource, IAppaTaskAsyncEnumerator<IList<TSource>>
        {
    ...
    internal sealed class BufferSkip<TSource> : IAppaTaskAsyncEnumerable<IList<TSource>>
    {
        private readonly IAppaTaskAsyncEnumerable<TSource> source;
        private readonly int count;
        private readonly int skip;

        public BufferSkip(IAppaTaskAsyncEnumerable<TSource> source, int count, int skip)
        {
            this.source = source;
            this.count = count;
            this.skip = skip;
        ...
        private sealed class _BufferSkip : MoveNextSource, IAppaTaskAsyncEnumerator<IList<TSource>>
        {
            private static readonly Action<object> MoveNextCoreDelegate = MoveNextCore;
