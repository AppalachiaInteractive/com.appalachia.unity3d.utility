...
namespace Appalachia.Utility.Async.Triggers
{
    ...
    {
        AppaTask FixedUpdateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncFixedUpdateHandler
    {
        AppaTask IAsyncFixedUpdateHandler.FixedUpdateAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    }
    ...
    public sealed class AsyncFixedUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask FixedUpdateAsync()
        {
            return ((IAsyncFixedUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .FixedUpdateAsync();
        }

        public AppaTask FixedUpdateAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncFixedUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).FixedUpdateAsync();
    ...
    {
        AppaTask LateUpdateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncLateUpdateHandler
    {
        AppaTask IAsyncLateUpdateHandler.LateUpdateAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncLateUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask LateUpdateAsync()
        {
            return ((IAsyncLateUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .LateUpdateAsync();
        }

        public AppaTask LateUpdateAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncLateUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).LateUpdateAsync();
    ...
    {
        AppaTask<int> OnAnimatorIKAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAnimatorIKHandler
    {
        AppaTask<int> IAsyncOnAnimatorIKHandler.OnAnimatorIKAsync()
        {
            core.Reset();
            return new AppaTask<int>((IAppaTaskSource<int>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncAnimatorIKTrigger : AsyncTriggerBase<int>
    {
        ...
        public AppaTask<int> OnAnimatorIKAsync()
        {
            return ((IAsyncOnAnimatorIKHandler)new AsyncTriggerHandler<int>(this, true)).OnAnimatorIKAsync();
        }

        public AppaTask<int> OnAnimatorIKAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnAnimatorMoveAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAnimatorMoveHandler
    {
        AppaTask IAsyncOnAnimatorMoveHandler.OnAnimatorMoveAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncAnimatorMoveTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnAnimatorMoveAsync()
        {
            return ((IAsyncOnAnimatorMoveHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnAnimatorMoveAsync();
        }

        public AppaTask OnAnimatorMoveAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnAnimatorMoveHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnAnimatorMoveAsync();
    ...
    {
        AppaTask<bool> OnApplicationFocusAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationFocusHandler
    {
        AppaTask<bool> IAsyncOnApplicationFocusHandler.OnApplicationFocusAsync()
        {
            core.Reset();
            return new AppaTask<bool>((IAppaTaskSource<bool>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncApplicationFocusTrigger : AsyncTriggerBase<bool>
    {
        ...
        public AppaTask<bool> OnApplicationFocusAsync()
        {
            return ((IAsyncOnApplicationFocusHandler)new AsyncTriggerHandler<bool>(this, true))
               .OnApplicationFocusAsync();
        }

        public AppaTask<bool> OnApplicationFocusAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnApplicationFocusHandler)new AsyncTriggerHandler<bool>(
                this,
                cancellationToken,
                true
            )).OnApplicationFocusAsync();
    ...
    {
        AppaTask<bool> OnApplicationPauseAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationPauseHandler
    {
        AppaTask<bool> IAsyncOnApplicationPauseHandler.OnApplicationPauseAsync()
        {
            core.Reset();
            return new AppaTask<bool>((IAppaTaskSource<bool>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationPauseTrigger : AsyncTriggerBase<bool>
    {
        ...
        public AppaTask<bool> OnApplicationPauseAsync()
        {
            return ((IAsyncOnApplicationPauseHandler)new AsyncTriggerHandler<bool>(this, true))
               .OnApplicationPauseAsync();
        }

        public AppaTask<bool> OnApplicationPauseAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnApplicationPauseHandler)new AsyncTriggerHandler<bool>(
                this,
                cancellationToken,
                true
            )).OnApplicationPauseAsync();
    ...
    {
        AppaTask OnApplicationQuitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnApplicationQuitHandler
    {
        AppaTask IAsyncOnApplicationQuitHandler.OnApplicationQuitAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncApplicationQuitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnApplicationQuitAsync()
        {
            return ((IAsyncOnApplicationQuitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnApplicationQuitAsync();
        }

        public AppaTask OnApplicationQuitAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnApplicationQuitHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnApplicationQuitAsync();
    ...
    {
        AppaTask<(float[] data, int channels)> OnAudioFilterReadAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnAudioFilterReadHandler
    {
        AppaTask<(float[] data, int channels)> IAsyncOnAudioFilterReadHandler.OnAudioFilterReadAsync()
        {
            core.Reset();
            return new AppaTask<(float[] data, int channels)>(
                (IAppaTaskSource<(float[] data, int channels)>)(object)this,
                core.Version
            );
        }
    }
    ...
    public sealed class AsyncAudioFilterReadTrigger : AsyncTriggerBase<(float[] data, int channels)>
    {
        ...
        public AppaTask<(float[] data, int channels)> OnAudioFilterReadAsync()
        {
    ...
    {
        AppaTask OnBecameInvisibleAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBecameInvisibleHandler
    {
        AppaTask IAsyncOnBecameInvisibleHandler.OnBecameInvisibleAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncBecameInvisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnBecameInvisibleAsync()
        {
            return ((IAsyncOnBecameInvisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnBecameInvisibleAsync();
        }

        public AppaTask OnBecameInvisibleAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnBecameInvisibleHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnBecameInvisibleAsync();
    ...
    {
        AppaTask OnBecameVisibleAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBecameVisibleHandler
    {
        AppaTask IAsyncOnBecameVisibleHandler.OnBecameVisibleAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncBecameVisibleTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnBecameVisibleAsync()
        {
            return ((IAsyncOnBecameVisibleHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnBecameVisibleAsync();
        }

        public AppaTask OnBecameVisibleAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnBecameVisibleHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnBecameVisibleAsync();
    ...
    {
        AppaTask OnBeforeTransformParentChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBeforeTransformParentChangedHandler
    {
        AppaTask IAsyncOnBeforeTransformParentChangedHandler.OnBeforeTransformParentChangedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncBeforeTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnBeforeTransformParentChangedAsync()
        {
        ...
        public AppaTask OnBeforeTransformParentChangedAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnBeforeTransformParentChangedHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
    ...
    {
        AppaTask OnCanvasGroupChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCanvasGroupChangedHandler
    {
        AppaTask IAsyncOnCanvasGroupChangedHandler.OnCanvasGroupChangedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncOnCanvasGroupChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnCanvasGroupChangedAsync()
        {
            return ((IAsyncOnCanvasGroupChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnCanvasGroupChangedAsync();
        }

        public AppaTask OnCanvasGroupChangedAsync(CancellationToken cancellationToken)
        {
...
#if !UNITY_2019_1_OR_NEWER || APPATASK_PHYSICS_SUPPORT

    public interface IAsyncOnCollisionEnterHandler
    {
        AppaTask<Collision> OnCollisionEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionEnterHandler
    {
        AppaTask<Collision> IAsyncOnCollisionEnterHandler.OnCollisionEnterAsync()
        {
            core.Reset();
            return new AppaTask<Collision>((IAppaTaskSource<Collision>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnterTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public AppaTask<Collision> OnCollisionEnterAsync()
        {
            return ((IAsyncOnCollisionEnterHandler)new AsyncTriggerHandler<Collision>(this, true))
               .OnCollisionEnterAsync();
        }

        public AppaTask<Collision> OnCollisionEnterAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnCollisionEnterHandler)new AsyncTriggerHandler<Collision>(
                this,
                cancellationToken,
                true
            )).OnCollisionEnterAsync();
...
#if !UNITY_2019_1_OR_NEWER || APPATASK_PHYSICS2D_SUPPORT

    public interface IAsyncOnCollisionEnter2DHandler
    {
        AppaTask<Collision2D> OnCollisionEnter2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionEnter2DHandler
    {
        AppaTask<Collision2D> IAsyncOnCollisionEnter2DHandler.OnCollisionEnter2DAsync()
        {
            core.Reset();
            return new AppaTask<Collision2D>((IAppaTaskSource<Collision2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCollisionEnter2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public AppaTask<Collision2D> OnCollisionEnter2DAsync()
        {
            return ((IAsyncOnCollisionEnter2DHandler)new AsyncTriggerHandler<Collision2D>(this, true))
               .OnCollisionEnter2DAsync();
        }

        public AppaTask<Collision2D> OnCollisionEnter2DAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<Collision> OnCollisionExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionExitHandler
    {
        AppaTask<Collision> IAsyncOnCollisionExitHandler.OnCollisionExitAsync()
        {
            core.Reset();
            return new AppaTask<Collision>((IAppaTaskSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExitTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public AppaTask<Collision> OnCollisionExitAsync()
        {
            return ((IAsyncOnCollisionExitHandler)new AsyncTriggerHandler<Collision>(this, true))
               .OnCollisionExitAsync();
        }

        public AppaTask<Collision> OnCollisionExitAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnCollisionExitHandler)new AsyncTriggerHandler<Collision>(
                this,
                cancellationToken,
                true
            )).OnCollisionExitAsync();
    ...
    {
        AppaTask<Collision2D> OnCollisionExit2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionExit2DHandler
    {
        AppaTask<Collision2D> IAsyncOnCollisionExit2DHandler.OnCollisionExit2DAsync()
        {
            core.Reset();
            return new AppaTask<Collision2D>((IAppaTaskSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionExit2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public AppaTask<Collision2D> OnCollisionExit2DAsync()
        {
            return ((IAsyncOnCollisionExit2DHandler)new AsyncTriggerHandler<Collision2D>(this, true))
               .OnCollisionExit2DAsync();
        }

        public AppaTask<Collision2D> OnCollisionExit2DAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnCollisionExit2DHandler)new AsyncTriggerHandler<Collision2D>(
                this,
                cancellationToken,
                true
            )).OnCollisionExit2DAsync();
    ...
    {
        AppaTask<Collision> OnCollisionStayAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionStayHandler
    {
        AppaTask<Collision> IAsyncOnCollisionStayHandler.OnCollisionStayAsync()
        {
            core.Reset();
            return new AppaTask<Collision>((IAppaTaskSource<Collision>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStayTrigger : AsyncTriggerBase<Collision>
    {
        ...
        public AppaTask<Collision> OnCollisionStayAsync()
        {
            return ((IAsyncOnCollisionStayHandler)new AsyncTriggerHandler<Collision>(this, true))
               .OnCollisionStayAsync();
        }

        public AppaTask<Collision> OnCollisionStayAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnCollisionStayHandler)new AsyncTriggerHandler<Collision>(
                this,
                cancellationToken,
                true
            )).OnCollisionStayAsync();
    ...
    {
        AppaTask<Collision2D> OnCollisionStay2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCollisionStay2DHandler
    {
        AppaTask<Collision2D> IAsyncOnCollisionStay2DHandler.OnCollisionStay2DAsync()
        {
            core.Reset();
            return new AppaTask<Collision2D>((IAppaTaskSource<Collision2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncCollisionStay2DTrigger : AsyncTriggerBase<Collision2D>
    {
        ...
        public AppaTask<Collision2D> OnCollisionStay2DAsync()
        {
            return ((IAsyncOnCollisionStay2DHandler)new AsyncTriggerHandler<Collision2D>(this, true))
               .OnCollisionStay2DAsync();
        }

        public AppaTask<Collision2D> OnCollisionStay2DAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnCollisionStay2DHandler)new AsyncTriggerHandler<Collision2D>(
                this,
                cancellationToken,
                true
            )).OnCollisionStay2DAsync();
    ...
    {
        AppaTask<ControllerColliderHit> OnControllerColliderHitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnControllerColliderHitHandler
    {
        AppaTask<ControllerColliderHit> IAsyncOnControllerColliderHitHandler.OnControllerColliderHitAsync()
        {
            core.Reset();
            return new AppaTask<ControllerColliderHit>(
                (IAppaTaskSource<ControllerColliderHit>)(object)this,
                core.Version
            );
        }
    }
    ...
    public sealed class AsyncControllerColliderHitTrigger : AsyncTriggerBase<ControllerColliderHit>
    {
        ...
        public AppaTask<ControllerColliderHit> OnControllerColliderHitAsync()
        {
    ...
    {
        AppaTask OnDisableAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDisableHandler
    {
        AppaTask IAsyncOnDisableHandler.OnDisableAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncDisableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnDisableAsync()
        {
            return ((IAsyncOnDisableHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnDisableAsync();
        }

        public AppaTask OnDisableAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnDrawGizmosAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDrawGizmosHandler
    {
        AppaTask IAsyncOnDrawGizmosHandler.OnDrawGizmosAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncDrawGizmosTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnDrawGizmosAsync()
        {
            return ((IAsyncOnDrawGizmosHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnDrawGizmosAsync();
        }

        public AppaTask OnDrawGizmosAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnDrawGizmosHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnDrawGizmosAsync();
    ...
    {
        AppaTask OnDrawGizmosSelectedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDrawGizmosSelectedHandler
    {
        AppaTask IAsyncOnDrawGizmosSelectedHandler.OnDrawGizmosSelectedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public static partial class AsyncTriggerExtensions
    {
        public static AsyncDrawGizmosSelectedTrigger GetAsyncDrawGizmosSelectedTrigger(
            this GameObject gameObject)
        {
    ...
    public sealed class AsyncDrawGizmosSelectedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnDrawGizmosSelectedAsync()
        {
            return ((IAsyncOnDrawGizmosSelectedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnDrawGizmosSelectedAsync();
        }

        public AppaTask OnDrawGizmosSelectedAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnEnableAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnEnableHandler
    {
        AppaTask IAsyncOnEnableHandler.OnEnableAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncEnableTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnEnableAsync()
        {
            return ((IAsyncOnEnableHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnEnableAsync();
        }

        public AppaTask OnEnableAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask IAsyncOnGUIHandler.OnGUIAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncGUITrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnGUIAsync()
        {
            return ((IAsyncOnGUIHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnGUIAsync();
        }

        public AppaTask OnGUIAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<float> OnJointBreakAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnJointBreakHandler
    {
        AppaTask<float> IAsyncOnJointBreakHandler.OnJointBreakAsync()
        {
            core.Reset();
            return new AppaTask<float>((IAppaTaskSource<float>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreakTrigger : AsyncTriggerBase<float>
    {
        ...
        public AppaTask<float> OnJointBreakAsync()
        {
            return ((IAsyncOnJointBreakHandler)new AsyncTriggerHandler<float>(this, true))
               .OnJointBreakAsync();
        }

        public AppaTask<float> OnJointBreakAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<Joint2D> OnJointBreak2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnJointBreak2DHandler
    {
        AppaTask<Joint2D> IAsyncOnJointBreak2DHandler.OnJointBreak2DAsync()
        {
            core.Reset();
            return new AppaTask<Joint2D>((IAppaTaskSource<Joint2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncJointBreak2DTrigger : AsyncTriggerBase<Joint2D>
    {
        ...
        public AppaTask<Joint2D> OnJointBreak2DAsync()
        {
            return ((IAsyncOnJointBreak2DHandler)new AsyncTriggerHandler<Joint2D>(this, true))
               .OnJointBreak2DAsync();
        }

        public AppaTask<Joint2D> OnJointBreak2DAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnJointBreak2DHandler)new AsyncTriggerHandler<Joint2D>(
                this,
                cancellationToken,
                true
            )).OnJointBreak2DAsync();
    ...
    {
        AppaTask OnMouseDownAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseDownHandler
    {
        AppaTask IAsyncOnMouseDownHandler.OnMouseDownAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDownTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseDownAsync()
        {
            return ((IAsyncOnMouseDownHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnMouseDownAsync();
        }

        public AppaTask OnMouseDownAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMouseDownHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnMouseDownAsync();
    ...
    {
        AppaTask OnMouseDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseDragHandler
    {
        AppaTask IAsyncOnMouseDragHandler.OnMouseDragAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseDragTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseDragAsync()
        {
            return ((IAsyncOnMouseDragHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnMouseDragAsync();
        }

        public AppaTask OnMouseDragAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMouseDragHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnMouseDragAsync();
    ...
    {
        AppaTask OnMouseEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseEnterHandler
    {
        AppaTask IAsyncOnMouseEnterHandler.OnMouseEnterAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseEnterTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseEnterAsync()
        {
            return ((IAsyncOnMouseEnterHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnMouseEnterAsync();
        }

        public AppaTask OnMouseEnterAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMouseEnterHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnMouseEnterAsync();
    ...
    {
        AppaTask OnMouseExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseExitHandler
    {
        AppaTask IAsyncOnMouseExitHandler.OnMouseExitAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseExitTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseExitAsync()
        {
            return ((IAsyncOnMouseExitHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnMouseExitAsync();
        }

        public AppaTask OnMouseExitAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMouseExitHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnMouseExitAsync();
    ...
    {
        AppaTask OnMouseOverAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseOverHandler
    {
        AppaTask IAsyncOnMouseOverHandler.OnMouseOverAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseOverTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseOverAsync()
        {
            return ((IAsyncOnMouseOverHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnMouseOverAsync();
        }

        public AppaTask OnMouseOverAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMouseOverHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnMouseOverAsync();
    ...
    {
        AppaTask OnMouseUpAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseUpHandler
    {
        AppaTask IAsyncOnMouseUpHandler.OnMouseUpAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseUpAsync()
        {
            return ((IAsyncOnMouseUpHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnMouseUpAsync();
        }

        public AppaTask OnMouseUpAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnMouseUpAsButtonAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMouseUpAsButtonHandler
    {
        AppaTask IAsyncOnMouseUpAsButtonHandler.OnMouseUpAsButtonAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncMouseUpAsButtonTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnMouseUpAsButtonAsync()
        {
            return ((IAsyncOnMouseUpAsButtonHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnMouseUpAsButtonAsync();
        }

        public AppaTask OnMouseUpAsButtonAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMouseUpAsButtonHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnMouseUpAsButtonAsync();
    ...
    {
        AppaTask<GameObject> OnParticleCollisionAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleCollisionHandler
    {
        AppaTask<GameObject> IAsyncOnParticleCollisionHandler.OnParticleCollisionAsync()
        {
            core.Reset();
            return new AppaTask<GameObject>((IAppaTaskSource<GameObject>)(object)this, core.Version);
        }
    }

    public static partial class AsyncTriggerExtensions
    {
        public static AsyncParticleCollisionTrigger GetAsyncParticleCollisionTrigger(
            this GameObject gameObject)
        {
    ...
    public sealed class AsyncParticleCollisionTrigger : AsyncTriggerBase<GameObject>
    {
        ...
        public AppaTask<GameObject> OnParticleCollisionAsync()
        {
            return ((IAsyncOnParticleCollisionHandler)new AsyncTriggerHandler<GameObject>(this, true))
               .OnParticleCollisionAsync();
        }

        public AppaTask<GameObject> OnParticleCollisionAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnParticleSystemStoppedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleSystemStoppedHandler
    {
        AppaTask IAsyncOnParticleSystemStoppedHandler.OnParticleSystemStoppedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncParticleSystemStoppedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnParticleSystemStoppedAsync()
        {
            return ((IAsyncOnParticleSystemStoppedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnParticleSystemStoppedAsync();
        }

        public AppaTask OnParticleSystemStoppedAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnParticleTriggerAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleTriggerHandler
    {
        AppaTask IAsyncOnParticleTriggerHandler.OnParticleTriggerAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncParticleTriggerTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnParticleTriggerAsync()
        {
            return ((IAsyncOnParticleTriggerHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnParticleTriggerAsync();
        }

        public AppaTask OnParticleTriggerAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnParticleTriggerHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnParticleTriggerAsync();
...
#if UNITY_2019_3_OR_NEWER && (!UNITY_2019_1_OR_NEWER || APPATASK_PARTICLESYSTEM_SUPPORT)

    public interface IAsyncOnParticleUpdateJobScheduledHandler
    {
        AppaTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData> OnParticleUpdateJobScheduledAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnParticleUpdateJobScheduledHandler
    {
        AppaTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
            IAsyncOnParticleUpdateJobScheduledHandler.OnParticleUpdateJobScheduledAsync()
        {
            core.Reset();
            return new AppaTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>(
                (IAppaTaskSource<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>)(object)this,
                core.Version
            );
        }
    }
            ...
            UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
    {
        private void OnParticleUpdateJobScheduled(
            UnityEngine.ParticleSystemJobs.ParticleSystemJobData particles)
        {
        ...
        public AppaTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
            OnParticleUpdateJobScheduledAsync()
        {
            return ((IAsyncOnParticleUpdateJobScheduledHandler)new
                    AsyncTriggerHandler<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>(this, true))
               .OnParticleUpdateJobScheduledAsync();
        }

        public AppaTask<UnityEngine.ParticleSystemJobs.ParticleSystemJobData>
            OnParticleUpdateJobScheduledAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnParticleUpdateJobScheduledHandler)new
    ...
    {
        AppaTask OnPostRenderAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPostRenderHandler
    {
        AppaTask IAsyncOnPostRenderHandler.OnPostRenderAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncPostRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnPostRenderAsync()
        {
            return ((IAsyncOnPostRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnPostRenderAsync();
        }

        public AppaTask OnPostRenderAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnPostRenderHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnPostRenderAsync();
    ...
    {
        AppaTask OnPreCullAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPreCullHandler
    {
        AppaTask IAsyncOnPreCullHandler.OnPreCullAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncPreCullTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnPreCullAsync()
        {
            return ((IAsyncOnPreCullHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).OnPreCullAsync();
        }

        public AppaTask OnPreCullAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnPreRenderAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPreRenderHandler
    {
        AppaTask IAsyncOnPreRenderHandler.OnPreRenderAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncPreRenderTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnPreRenderAsync()
        {
            return ((IAsyncOnPreRenderHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnPreRenderAsync();
        }

        public AppaTask OnPreRenderAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnPreRenderHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnPreRenderAsync();
    ...
    {
        AppaTask OnRectTransformDimensionsChangeAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRectTransformDimensionsChangeHandler
    {
        AppaTask IAsyncOnRectTransformDimensionsChangeHandler.OnRectTransformDimensionsChangeAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncRectTransformDimensionsChangeTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnRectTransformDimensionsChangeAsync()
        {
        ...
        public AppaTask OnRectTransformDimensionsChangeAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnRectTransformDimensionsChangeHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
    ...
    {
        AppaTask OnRectTransformRemovedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRectTransformRemovedHandler
    {
        AppaTask IAsyncOnRectTransformRemovedHandler.OnRectTransformRemovedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public static partial class AsyncTriggerExtensions
    {
        public static AsyncRectTransformRemovedTrigger GetAsyncRectTransformRemovedTrigger(
            this GameObject gameObject)
        {
    ...
    public sealed class AsyncRectTransformRemovedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnRectTransformRemovedAsync()
        {
            return ((IAsyncOnRectTransformRemovedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnRectTransformRemovedAsync();
        }

        public AppaTask OnRectTransformRemovedAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderImageHandler
    {
        AppaTask<(RenderTexture source, RenderTexture destination)> IAsyncOnRenderImageHandler.
            OnRenderImageAsync()
        {
            core.Reset();
            return new AppaTask<(RenderTexture source, RenderTexture destination)>(
                (IAppaTaskSource<(RenderTexture source, RenderTexture destination)>)(object)this,
                core.Version
            );
        }
    }
    ...
    [DisallowMultipleComponent]
    public sealed class
        AsyncRenderImageTrigger : AsyncTriggerBase<(RenderTexture source, RenderTexture destination)>
    {
        ...
        public AppaTask<(RenderTexture source, RenderTexture destination)> OnRenderImageAsync()
        {
    ...
    {
        AppaTask OnRenderObjectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnRenderObjectHandler
    {
        AppaTask IAsyncOnRenderObjectHandler.OnRenderObjectAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnRenderObjectAsync()
        {
            return ((IAsyncOnRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnRenderObjectAsync();
        }

        public AppaTask OnRenderObjectAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnRenderObjectAsync();
    ...
    {
        AppaTask OnServerInitializedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnServerInitializedHandler
    {
        AppaTask IAsyncOnServerInitializedHandler.OnServerInitializedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public static partial class AsyncTriggerExtensions
    {
        public static AsyncServerInitializedTrigger GetAsyncServerInitializedTrigger(
            this GameObject gameObject)
        {
    ...
    public sealed class AsyncServerInitializedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnServerInitializedAsync()
        {
            return ((IAsyncOnServerInitializedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnServerInitializedAsync();
        }

        public AppaTask OnServerInitializedAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnServerInitializedHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnServerInitializedAsync();
    ...
    {
        AppaTask OnTransformChildrenChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTransformChildrenChangedHandler
    {
        AppaTask IAsyncOnTransformChildrenChangedHandler.OnTransformChildrenChangedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncTransformChildrenChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnTransformChildrenChangedAsync()
        {
        ...
        public AppaTask OnTransformChildrenChangedAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask OnTransformParentChangedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTransformParentChangedHandler
    {
        AppaTask IAsyncOnTransformParentChangedHandler.OnTransformParentChangedAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncTransformParentChangedTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnTransformParentChangedAsync()
        {
            return ((IAsyncOnTransformParentChangedHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnTransformParentChangedAsync();
        }

        public AppaTask OnTransformParentChangedAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<Collider> OnTriggerEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerEnterHandler
    {
        AppaTask<Collider> IAsyncOnTriggerEnterHandler.OnTriggerEnterAsync()
        {
            core.Reset();
            return new AppaTask<Collider>((IAppaTaskSource<Collider>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnterTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public AppaTask<Collider> OnTriggerEnterAsync()
        {
            return ((IAsyncOnTriggerEnterHandler)new AsyncTriggerHandler<Collider>(this, true))
               .OnTriggerEnterAsync();
        }

        public AppaTask<Collider> OnTriggerEnterAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnTriggerEnterHandler)new AsyncTriggerHandler<Collider>(
                this,
                cancellationToken,
                true
            )).OnTriggerEnterAsync();
    ...
    {
        AppaTask<Collider2D> OnTriggerEnter2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerEnter2DHandler
    {
        AppaTask<Collider2D> IAsyncOnTriggerEnter2DHandler.OnTriggerEnter2DAsync()
        {
            core.Reset();
            return new AppaTask<Collider2D>((IAppaTaskSource<Collider2D>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncTriggerEnter2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public AppaTask<Collider2D> OnTriggerEnter2DAsync()
        {
            return ((IAsyncOnTriggerEnter2DHandler)new AsyncTriggerHandler<Collider2D>(this, true))
               .OnTriggerEnter2DAsync();
        }

        public AppaTask<Collider2D> OnTriggerEnter2DAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnTriggerEnter2DHandler)new AsyncTriggerHandler<Collider2D>(
                this,
                cancellationToken,
                true
            )).OnTriggerEnter2DAsync();
    ...
    {
        AppaTask<Collider> OnTriggerExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerExitHandler
    {
        AppaTask<Collider> IAsyncOnTriggerExitHandler.OnTriggerExitAsync()
        {
            core.Reset();
            return new AppaTask<Collider>((IAppaTaskSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExitTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public AppaTask<Collider> OnTriggerExitAsync()
        {
            return ((IAsyncOnTriggerExitHandler)new AsyncTriggerHandler<Collider>(this, true))
               .OnTriggerExitAsync();
        }

        public AppaTask<Collider> OnTriggerExitAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnTriggerExitHandler)new AsyncTriggerHandler<Collider>(
                this,
                cancellationToken,
                true
            )).OnTriggerExitAsync();
    ...
    {
        AppaTask<Collider2D> OnTriggerExit2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerExit2DHandler
    {
        AppaTask<Collider2D> IAsyncOnTriggerExit2DHandler.OnTriggerExit2DAsync()
        {
            core.Reset();
            return new AppaTask<Collider2D>((IAppaTaskSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerExit2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public AppaTask<Collider2D> OnTriggerExit2DAsync()
        {
            return ((IAsyncOnTriggerExit2DHandler)new AsyncTriggerHandler<Collider2D>(this, true))
               .OnTriggerExit2DAsync();
        }

        public AppaTask<Collider2D> OnTriggerExit2DAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnTriggerExit2DHandler)new AsyncTriggerHandler<Collider2D>(
                this,
                cancellationToken,
                true
            )).OnTriggerExit2DAsync();
    ...
    {
        AppaTask<Collider> OnTriggerStayAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerStayHandler
    {
        AppaTask<Collider> IAsyncOnTriggerStayHandler.OnTriggerStayAsync()
        {
            core.Reset();
            return new AppaTask<Collider>((IAppaTaskSource<Collider>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStayTrigger : AsyncTriggerBase<Collider>
    {
        ...
        public AppaTask<Collider> OnTriggerStayAsync()
        {
            return ((IAsyncOnTriggerStayHandler)new AsyncTriggerHandler<Collider>(this, true))
               .OnTriggerStayAsync();
        }

        public AppaTask<Collider> OnTriggerStayAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnTriggerStayHandler)new AsyncTriggerHandler<Collider>(
                this,
                cancellationToken,
                true
            )).OnTriggerStayAsync();
    ...
    {
        AppaTask<Collider2D> OnTriggerStay2DAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnTriggerStay2DHandler
    {
        AppaTask<Collider2D> IAsyncOnTriggerStay2DHandler.OnTriggerStay2DAsync()
        {
            core.Reset();
            return new AppaTask<Collider2D>((IAppaTaskSource<Collider2D>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncTriggerStay2DTrigger : AsyncTriggerBase<Collider2D>
    {
        ...
        public AppaTask<Collider2D> OnTriggerStay2DAsync()
        {
            return ((IAsyncOnTriggerStay2DHandler)new AsyncTriggerHandler<Collider2D>(this, true))
               .OnTriggerStay2DAsync();
        }

        public AppaTask<Collider2D> OnTriggerStay2DAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnTriggerStay2DHandler)new AsyncTriggerHandler<Collider2D>(
                this,
                cancellationToken,
                true
            )).OnTriggerStay2DAsync();
    ...
    {
        AppaTask OnValidateAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnValidateHandler
    {
        AppaTask IAsyncOnValidateHandler.OnValidateAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncValidateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnValidateAsync()
        {
            return ((IAsyncOnValidateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnValidateAsync();
        }

        public AppaTask OnValidateAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnValidateHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnValidateAsync();
    ...
    {
        AppaTask OnWillRenderObjectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnWillRenderObjectHandler
    {
        AppaTask IAsyncOnWillRenderObjectHandler.OnWillRenderObjectAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncWillRenderObjectTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask OnWillRenderObjectAsync()
        {
            return ((IAsyncOnWillRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(this, true))
               .OnWillRenderObjectAsync();
        }

        public AppaTask OnWillRenderObjectAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnWillRenderObjectHandler)new AsyncTriggerHandler<AsyncUnit>(
                this,
                cancellationToken,
                true
            )).OnWillRenderObjectAsync();
    ...
    {
        AppaTask IAsyncResetHandler.ResetAsync()
        {
            core.Reset();
            return new AppaTask((IAppaTaskSource)this, core.Version);
        }
    ...
    public sealed class AsyncResetTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask ResetAsync()
        {
            return ((IAsyncResetHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).ResetAsync();
        }

        public AppaTask ResetAsync(CancellationToken cancellationToken)
        {
    ...
    public sealed class AsyncUpdateTrigger : AsyncTriggerBase<AsyncUnit>
    {
        ...
        public AppaTask UpdateAsync()
        {
            return ((IAsyncUpdateHandler)new AsyncTriggerHandler<AsyncUnit>(this, true)).UpdateAsync();
        }

        public AppaTask UpdateAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<PointerEventData> OnBeginDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnBeginDragHandler
    {
        AppaTask<PointerEventData> IAsyncOnBeginDragHandler.OnBeginDragAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
                core.Version
            );
        }
    }
    ...
    public sealed class AsyncBeginDragTrigger : AsyncTriggerBase<PointerEventData>, IBeginDragHandler
    {
        ...
        public AppaTask<PointerEventData> OnBeginDragAsync()
        {
            return ((IAsyncOnBeginDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnBeginDragAsync();
        }

        public AppaTask<PointerEventData> OnBeginDragAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnBeginDragHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
                true
            )).OnBeginDragAsync();
    ...
    {
        AppaTask<BaseEventData> OnCancelAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnCancelHandler
    {
        AppaTask<BaseEventData> IAsyncOnCancelHandler.OnCancelAsync()
        {
            core.Reset();
            return new AppaTask<BaseEventData>((IAppaTaskSource<BaseEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncCancelTrigger : AsyncTriggerBase<BaseEventData>, ICancelHandler
    {
        ...
        public AppaTask<BaseEventData> OnCancelAsync()
        {
            return ((IAsyncOnCancelHandler)new AsyncTriggerHandler<BaseEventData>(this, true))
               .OnCancelAsync();
        }

        public AppaTask<BaseEventData> OnCancelAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnCancelHandler)new AsyncTriggerHandler<BaseEventData>(
                this,
                cancellationToken,
                true
            )).OnCancelAsync();
    ...
    {
        AppaTask<BaseEventData> OnDeselectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDeselectHandler
    {
        AppaTask<BaseEventData> IAsyncOnDeselectHandler.OnDeselectAsync()
        {
            core.Reset();
            return new AppaTask<BaseEventData>((IAppaTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncDeselectTrigger : AsyncTriggerBase<BaseEventData>, IDeselectHandler
    {
        ...
        public AppaTask<BaseEventData> OnDeselectAsync()
        {
            return ((IAsyncOnDeselectHandler)new AsyncTriggerHandler<BaseEventData>(this, true))
               .OnDeselectAsync();
        }

        public AppaTask<BaseEventData> OnDeselectAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnDeselectHandler)new AsyncTriggerHandler<BaseEventData>(
                this,
                cancellationToken,
                true
            )).OnDeselectAsync();
    ...
    {
        AppaTask<PointerEventData> OnDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDragHandler
    {
        AppaTask<PointerEventData> IAsyncOnDragHandler.OnDragAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncDragTrigger : AsyncTriggerBase<PointerEventData>, IDragHandler
    {
        ...
        public AppaTask<PointerEventData> OnDragAsync()
        {
            return ((IAsyncOnDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDragAsync();
        }

        public AppaTask<PointerEventData> OnDragAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnDragHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
                true
            )).OnDragAsync();
    ...
    {
        AppaTask<PointerEventData> OnDropAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnDropHandler
    {
        AppaTask<PointerEventData> IAsyncOnDropHandler.OnDropAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncDropTrigger : AsyncTriggerBase<PointerEventData>, IDropHandler
    {
        ...
        public AppaTask<PointerEventData> OnDropAsync()
        {
            return ((IAsyncOnDropHandler)new AsyncTriggerHandler<PointerEventData>(this, true)).OnDropAsync();
        }

        public AppaTask<PointerEventData> OnDropAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnDropHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
                true
            )).OnDropAsync();
    ...
    {
        AppaTask<PointerEventData> OnEndDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnEndDragHandler
    {
        AppaTask<PointerEventData> IAsyncOnEndDragHandler.OnEndDragAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncEndDragTrigger : AsyncTriggerBase<PointerEventData>, IEndDragHandler
    {
        ...
        public AppaTask<PointerEventData> OnEndDragAsync()
        {
            return ((IAsyncOnEndDragHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnEndDragAsync();
        }

        public AppaTask<PointerEventData> OnEndDragAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnEndDragHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
                true
            )).OnEndDragAsync();
    ...
    {
        AppaTask<PointerEventData> OnInitializePotentialDragAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnInitializePotentialDragHandler
    {
        AppaTask<PointerEventData> IAsyncOnInitializePotentialDragHandler.OnInitializePotentialDragAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
                                                              ...
                                                              IInitializePotentialDragHandler
    {
        ...
        public AppaTask<PointerEventData> OnInitializePotentialDragAsync()
        {
        ...
        public AppaTask<PointerEventData> OnInitializePotentialDragAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnInitializePotentialDragHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
    ...
    {
        AppaTask<AxisEventData> OnMoveAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnMoveHandler
    {
        AppaTask<AxisEventData> IAsyncOnMoveHandler.OnMoveAsync()
        {
            core.Reset();
            return new AppaTask<AxisEventData>((IAppaTaskSource<AxisEventData>)(object)this, core.Version);
        }
    }
    ...
    public sealed class AsyncMoveTrigger : AsyncTriggerBase<AxisEventData>, IMoveHandler
    {
        ...
        public AppaTask<AxisEventData> OnMoveAsync()
        {
            return ((IAsyncOnMoveHandler)new AsyncTriggerHandler<AxisEventData>(this, true)).OnMoveAsync();
        }

        public AppaTask<AxisEventData> OnMoveAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnMoveHandler)new AsyncTriggerHandler<AxisEventData>(
                this,
                cancellationToken,
                true
            )).OnMoveAsync();
    ...
    {
        AppaTask<PointerEventData> OnPointerClickAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerClickHandler
    {
        AppaTask<PointerEventData> IAsyncOnPointerClickHandler.OnPointerClickAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncPointerClickTrigger : AsyncTriggerBase<PointerEventData>, IPointerClickHandler
    {
        ...
        public AppaTask<PointerEventData> OnPointerClickAsync()
        {
            return ((IAsyncOnPointerClickHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnPointerClickAsync();
        }

        public AppaTask<PointerEventData> OnPointerClickAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<PointerEventData> OnPointerDownAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerDownHandler
    {
        AppaTask<PointerEventData> IAsyncOnPointerDownHandler.OnPointerDownAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncPointerDownTrigger : AsyncTriggerBase<PointerEventData>, IPointerDownHandler
    {
        ...
        public AppaTask<PointerEventData> OnPointerDownAsync()
        {
            return ((IAsyncOnPointerDownHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnPointerDownAsync();
        }

        public AppaTask<PointerEventData> OnPointerDownAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<PointerEventData> OnPointerEnterAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerEnterHandler
    {
        AppaTask<PointerEventData> IAsyncOnPointerEnterHandler.OnPointerEnterAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncPointerEnterTrigger : AsyncTriggerBase<PointerEventData>, IPointerEnterHandler
    {
        ...
        public AppaTask<PointerEventData> OnPointerEnterAsync()
        {
            return ((IAsyncOnPointerEnterHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnPointerEnterAsync();
        }

        public AppaTask<PointerEventData> OnPointerEnterAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<PointerEventData> OnPointerExitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerExitHandler
    {
        AppaTask<PointerEventData> IAsyncOnPointerExitHandler.OnPointerExitAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncPointerExitTrigger : AsyncTriggerBase<PointerEventData>, IPointerExitHandler
    {
        ...
        public AppaTask<PointerEventData> OnPointerExitAsync()
        {
            return ((IAsyncOnPointerExitHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnPointerExitAsync();
        }

        public AppaTask<PointerEventData> OnPointerExitAsync(CancellationToken cancellationToken)
        {
    ...
    {
        AppaTask<PointerEventData> OnPointerUpAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnPointerUpHandler
    {
        AppaTask<PointerEventData> IAsyncOnPointerUpHandler.OnPointerUpAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncPointerUpTrigger : AsyncTriggerBase<PointerEventData>, IPointerUpHandler
    {
        ...
        public AppaTask<PointerEventData> OnPointerUpAsync()
        {
            return ((IAsyncOnPointerUpHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnPointerUpAsync();
        }

        public AppaTask<PointerEventData> OnPointerUpAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnPointerUpHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
                true
            )).OnPointerUpAsync();
    ...
    {
        AppaTask<PointerEventData> OnScrollAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnScrollHandler
    {
        AppaTask<PointerEventData> IAsyncOnScrollHandler.OnScrollAsync()
        {
            core.Reset();
            return new AppaTask<PointerEventData>(
                (IAppaTaskSource<PointerEventData>)(object)this,
    ...
    public sealed class AsyncScrollTrigger : AsyncTriggerBase<PointerEventData>, IScrollHandler
    {
        ...
        public AppaTask<PointerEventData> OnScrollAsync()
        {
            return ((IAsyncOnScrollHandler)new AsyncTriggerHandler<PointerEventData>(this, true))
               .OnScrollAsync();
        }

        public AppaTask<PointerEventData> OnScrollAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnScrollHandler)new AsyncTriggerHandler<PointerEventData>(
                this,
                cancellationToken,
                true
            )).OnScrollAsync();
    ...
    {
        AppaTask<BaseEventData> OnSelectAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnSelectHandler
    {
        AppaTask<BaseEventData> IAsyncOnSelectHandler.OnSelectAsync()
        {
            core.Reset();
            return new AppaTask<BaseEventData>((IAppaTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSelectTrigger : AsyncTriggerBase<BaseEventData>, ISelectHandler
    {
        ...
        public AppaTask<BaseEventData> OnSelectAsync()
        {
            return ((IAsyncOnSelectHandler)new AsyncTriggerHandler<BaseEventData>(this, true))
               .OnSelectAsync();
        }

        public AppaTask<BaseEventData> OnSelectAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnSelectHandler)new AsyncTriggerHandler<BaseEventData>(
                this,
                cancellationToken,
                true
            )).OnSelectAsync();
    ...
    {
        AppaTask<BaseEventData> OnSubmitAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnSubmitHandler
    {
        AppaTask<BaseEventData> IAsyncOnSubmitHandler.OnSubmitAsync()
        {
            core.Reset();
            return new AppaTask<BaseEventData>((IAppaTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncSubmitTrigger : AsyncTriggerBase<BaseEventData>, ISubmitHandler
    {
        ...
        public AppaTask<BaseEventData> OnSubmitAsync()
        {
            return ((IAsyncOnSubmitHandler)new AsyncTriggerHandler<BaseEventData>(this, true))
               .OnSubmitAsync();
        }

        public AppaTask<BaseEventData> OnSubmitAsync(CancellationToken cancellationToken)
        {
            return ((IAsyncOnSubmitHandler)new AsyncTriggerHandler<BaseEventData>(
                this,
                cancellationToken,
                true
            )).OnSubmitAsync();
    ...
    {
        AppaTask<BaseEventData> OnUpdateSelectedAsync();
    }

    public partial class AsyncTriggerHandler<T> : IAsyncOnUpdateSelectedHandler
    {
        AppaTask<BaseEventData> IAsyncOnUpdateSelectedHandler.OnUpdateSelectedAsync()
        {
            core.Reset();
            return new AppaTask<BaseEventData>((IAppaTaskSource<BaseEventData>)(object)this, core.Version);
        }
    ...
    public sealed class AsyncUpdateSelectedTrigger : AsyncTriggerBase<BaseEventData>, IUpdateSelectedHandler
    {
        ...
        public AppaTask<BaseEventData> OnUpdateSelectedAsync()
        {
            return ((IAsyncOnUpdateSelectedHandler)new AsyncTriggerHandler<BaseEventData>(this, true))
               .OnUpdateSelectedAsync();
        }

        public AppaTask<BaseEventData> OnUpdateSelectedAsync(CancellationToken cancellationToken)
        {
