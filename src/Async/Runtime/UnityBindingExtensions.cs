...
namespace Appalachia.Utility.Async
{
    public static class UnityBindingExtensions
    {
        ...
        public static void BindTo(
            this IAppaTaskAsyncEnumerable<string> source,
            Text text,
        ...
        private static async AppaTaskVoid BindToCore(
            IAppaTaskAsyncEnumerable<string> source,
            Text text,
            CancellationToken cancellationToken,
            bool rebindOnError)
        {
        ...
        private static async AppaTaskVoid BindToCore<T>(
        ...
        public static void BindTo(
            this IAppaTaskAsyncEnumerable<bool> source,
            ...
            bool rebindOnError = true)
        {
            BindToCore(
                    source,
                    selectable,
                    selectable.GetCancellationTokenOnDestroy(),
                    rebindOnError
                )
               .Forget();
        }
        ...
        private static async AppaTaskVoid BindToCore(
            IAppaTaskAsyncEnumerable<bool> source,
            Selectable selectable,
            CancellationToken cancellationToken,
            bool rebindOnError)
        {
        ...
        private static async AppaTaskVoid BindToCore<TSource, TObject>(
