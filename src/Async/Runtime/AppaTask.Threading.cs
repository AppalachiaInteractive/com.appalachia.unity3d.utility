...
namespace Appalachia.Utility.Async
{
    public partial struct AppaTask
    {
        ...
        /// <summary>
        ///     If running on mainthread, do nothing. Otherwise, same as AppaTask.Yield(PlayerLoopTiming.Update).
        /// </summary>
        ...
        /// <summary>
        ///     If running on mainthread, do nothing. Otherwise, same as AppaTask.Yield(timing).
        /// </summary>
        public static SwitchToMainThreadAwaitable SwitchToMainThread(
