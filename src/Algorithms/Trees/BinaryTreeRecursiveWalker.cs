...
using Appalachia.Utility.DataStructures.Trees;

// ReSharper disable NotResolvedInText
// ReSharper disable UnusedParameter.Global

namespace Appalachia.Utility.Algorithms.Trees
{
    /// <summary>
    ...
    public static class BinaryTreeRecursiveWalker
    {
        ...
        public static bool BinarySearch<T>(
            BSTNode<T> BinaryTreeRoot,
            T Value,
            TraversalMode Mode = TraversalMode.InOrder)
        ...
        ///     By default this method traverses the tree in inorder fashion.
        /// </summary>
        public static List<T> FindAllMatches<T>(
            BSTNode<T> BinaryTreeRoot,
            Predicate<T> Match,
            TraversalMode Mode = TraversalMode.InOrder)
            where T : IComparable<T>
        ...
        ///     By default this method traverses the tree in inorder fashion.
        /// </summary>
        public static void PrintAll<T>(BSTNode<T> BinaryTreeRoot, TraversalMode Mode = TraversalMode.InOrder)
            where T : IComparable<T>
        {
            if (BinaryTreeRoot == null)
            {
            ...
            var printAction = new Action<T>(nodeValue => Console.Write(string.Format("{0} ", nodeValue)));
        ...
        /// </summary>
        private static bool InOrderSearcher<T>(
            BSTNode<T> BinaryTreeRoot,
            T Value,
        ...
        /// </summary>
        private static void InOrderVisitor<T>(BSTNode<T> BinaryTreeRoot, Action<T> Action)
            where T : IComparable<T>
        {
            if (BinaryTreeRoot == null)
            {
        ...
        ///     Private helper method for Inorder Searcher.
        /// </summary>
        private static bool PostOrderSearcher<T>(
            BSTNode<T> BinaryTreeRoot,
            T Value,
            bool IsBinarySearchTree = false)
            where T : IComparable<T>
        ...
        /// </summary>
        private static void PostOrderVisitor<T>(BSTNode<T> BinaryTreeRoot, Action<T> Action)
            where T : IComparable<T>
        {
            if (BinaryTreeRoot == null)
            {
        ...
        /// </summary>
        private static bool PreOrderSearcher<T>(
            BSTNode<T> BinaryTreeRoot,
            T Value,
            bool IsBinarySearchTree = false)
            where T : IComparable<T>
        ...
        ///     Private helper method for Preorder Traversal.
        /// </summary>
        private static void PreOrderVisitor<T>(BSTNode<T> BinaryTreeRoot, Action<T> Action)
            where T : IComparable<T>
        {
            if (BinaryTreeRoot == null)
            {
