...
namespace Appalachia.Utility.Algorithms.Graphs
{
    public static class ConnectedComponents
    {
        ...
        /// </summary>
        public static List<List<TVertex>> Compute<TVertex>(IGraph<TVertex> Graph)
        ...
        /// </summary>
        private static List<TVertex> _bfsConnectedComponent<TVertex>(
            IGraph<TVertex> graph,
            TVertex source,
            ref HashSet<TVertex> visited)
            where TVertex : IComparable<TVertex>
        {
